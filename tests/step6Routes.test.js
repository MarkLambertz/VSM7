...
test("Step VI normal view exposes its two substeps and the static route editor", () => {
  ...
  assert.match(html, /src="\.\/e2e-robustness-check\.html\?v=20260725-step3-aspects-org-units"/);
  ...
  assert.match(channels, /src="\.\/channel-variety-check\.html\?vsm=\/vsm\.html%3Fv%3D20260725-step3-aspects-org-units&assetVersion=20260725-step3-aspects-org-units"/);
...
test("Step VI host and focus mode use one current module cache label", () => {
  ...
  assert.match(app, /steps\/step6\.js\?v=20260725-step3-aspects-org-units/);
  assert.match(focusMode, /\.\/step6\.js\?v=20260725-step3-aspects-org-units/);
  assert.match(app, /shared\/e2eRouteExport\.js\?v=20260725-step3-aspects-org-units/);
  assert.match(app, /shared\/channelVarietyExport\.js\?v=20260725-step3-aspects-org-units/);
});
